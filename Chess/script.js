...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const recordMove = (move, count) => {
        // Format the move for display in the move history
    ...
    const onDrop = (source, target) => {
        ...
        // Make a random move for the computer after a delay
    ...
    document.querySelector('.play-again').addEventListener('click', () => {
        // Reset the game, board, move history, move count, and user's color
        game.reset();
        board.start();
    ...
    document.querySelector('.set-pos').addEventListener('click', () => {
        // Prompt the user to enter a FEN notation for a desired position
    ...
    document.querySelector('.flip-board').addEventListener('click', () => {
        // Flip the board and make a random move for the computer
        board.flip();
        makeRandomMove();
